...
df_old = pd.read_csv("C:\ETG\OLD.csv", encoding='utf8')	# old result of the ETG software for comparison
df_vehicles = pd.read_csv("C:\ETG\TOTAL - Copy.csv", encoding='utf8')
df_price = pd.read_csv("C:\ETG\PRICE.csv", encoding='utf8')
...
df_vehicles = auxilary.mapping(df_vehicles)
